...
describe('fundamental snapshots', () => {
  ...
  it('parses schema v4 snapshots with market value coverage', () => {
    const value: FundamentalSnapshot = {
      ...snapshot('2026-08-05'),
      schemaVersion: 4,
      coverage: {
        ...snapshot('2026-08-05').coverage,
        latestTotalMarketValueCount: 5537,
        latestCirculatingMarketValueCount: 5537
      }
    }
  ...
  it('parses schema v6 snapshots with quarterly financial risk data', () => {
    const value: FundamentalSnapshot = {
      ...snapshot('2026-08-12'),
      schemaVersion: 6,
      latestQuarterlyReportDate: '2026-06-30',
      coverage: {
        ...snapshot('2026-08-12').coverage,
        latestQuarterlyRiskReportCount: 5400,
        completeQuarterlyRiskIndicatorCount: 5100
      }
    }
