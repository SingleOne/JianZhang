...
`CompanyReportService` 使用巨潮资讯股票组织列表和历史公告接口，按股票分别查询年报、半年报、一季报和三季报分类。返回结果以最新报告年度为基准，只保留最近五个报告年度，并记录报告标题、财年、公告时间、全文/摘要/英文版标记、修订标记和官方 PDF 链接；renderer 默认只显示报告全文，可按类型、财年和标题过滤，也可开启摘要及英文版。
