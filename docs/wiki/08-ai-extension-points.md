...
AI 助手的“券商导入”页支持粘贴文字、TXT、XLSX 和图片，统一提取三类已经发生的流水：买卖成交、税前现金分红和红利税。TXT 与 XLSX 先由主进程在本地读取，XLSX 不执行公式、宏或外部链接；图片只在当前 Provider 明确支持视觉输入时发送，当前支持 OpenAI、Gemini 和 Anthropic。
