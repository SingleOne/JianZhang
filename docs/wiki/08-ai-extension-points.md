...
- “长期价值”读取五年 ROE/ROIC、利润、现金流、自由现金流、负债、净负债、基本面质量与风险、分红融资、当前 PE/PB、近五年历史分位、快照日行业分位、总市值与流通市值，以及日 K 计算的 20/60/120/250 日收益、均线距离和 250 日价格位置；不读取分时、盘口、资金流、短线技术指标、筹码或即时新闻。
