...
- 管理分时、分红融资、基本面、财报库、资金流、市场观察、AI 分析、AI 做 T 参考、五日、日/周/月 K 和板块标签；可选模块标签按构建开关出现。
...
- 财报库页查询当前股票最近五个报告年度的巨潮定期报告，不提供搜索、财年或报告类型筛选，直接按报告所属财年分组并打开官方 PDF；默认展示全文，也可包含摘要和英文版。条目小字显示已保存总结，没有总结时可一键调用当前 AI 模型生成并保存；总结成功后复用主窗口底部的成功通知提示。
