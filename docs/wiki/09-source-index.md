...
| 文件 | 重点符号 | 职责 |
| --- | --- | --- |
| [`src/shared/types.ts`](../../src/shared/types.ts) | `AppState`、`StockQuote`、`TTradingBatch`、`StockDesktopApi` | 领域类型、默认值、状态规范化和列迁移 |
...
| [`src/components/PositionEditor.tsx`](../../src/components/PositionEditor.tsx) | 持仓编辑和版本快照 |
